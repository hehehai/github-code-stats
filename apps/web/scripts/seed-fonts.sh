...
npx wrangler r2 object put "$BUCKET/storage/noto-sans-sc-chinese-simplified-400-normal.woff" --file "$FONTS_DIR/noto-sans-sc.woff" --local --persist-to "$PERSIST_PATH"
